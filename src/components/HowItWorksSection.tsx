...
const HowItWorksSection = () => {
  ...
  return <section id="how-it-works-section" className="py-12 sm:py-16 bg-gradient-to-b from-background to-secondary/20">
      <div className="container mx-auto px-4">
        <motion.div ref={ref} className="text-center mb-12 sm:mb-16 lg:mb-20" initial={{
        opacity: 0,
        y: 50
      }} animate={isInView ? {
        opacity: 1,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16 lg:mb-20">
          {steps.map((step, index) => <motion.div key={step.title} className="relative" initial={{
          opacity: 0,
          y: 30
        }} animate={isInView ? {
          opacity: 1,
          ...
          duration: 0.4
              ...
              <div className="gradient-card rounded-3xl p-6 sm:p-8 hover-lift">
                ...
                duration: 0.2
                    ...
                    {step.premium && <div className={`absolute -bottom-2 -right-2 bg-gradient-to-r text-xs px-2 py-1 rounded-full font-bold ${step.isMax ? 'from-indigo-500 to-purple-600 text-white' : 'from-yellow-400 to-yellow-500 text-black'}`}>
                        {step.isMax ? 'MAX' : 'PRO'}
                      </div>}
                  </motion.div>
              ...
              {/* Connection Line */}
              {index < steps.length - 1 && <motion.div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-0.5 h-6 bg-gradient-to-b from-primary to-transparent lg:hidden" initial={{
            scaleY: 0
          }} animate={isInView ? {
            scaleY: 1
          } : {}} transition={{
          ...
          <div className="gradient-card rounded-3xl p-6 sm:p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="relative order-1 lg:order-2">
                <motion.div className="relative mx-auto w-48 h-96 sm:w-64 sm:h-[500px] bg-gradient-to-b from-gray-800 to-gray-900 rounded-[2.5rem] sm:rounded-[3rem] p-1.5 sm:p-2 shadow-2xl" animate={{
                y: [0, -10, 0]
              }} transition={{
                duration: 4,
                repeat: Infinity,
                      ...
                      <div className="bg-green-50 rounded-xl p-4">
                        ...
                        <div className="bg-white rounded-lg p-3">
                          ...
                          <svg viewBox="0 0 100 30" className="w-full h-8">
                            <motion.path d="M 5,25 Q 25,15 50,18 Q 75,20 95,22" fill="none" stroke="#10b981" strokeWidth="2" initial={{
                            pathLength: 0
                          }} animate={{
                            pathLength: 1
                          }} transition={{
                ...
                {/* Floating Elements */}
                <motion.div className="absolute -top-4 -right-4 w-8 h-8 bg-green-400 rounded-full opacity-60" animate={{
                scale: [1, 1.2, 1],
                rotate: [0, 180, 360]
              }} transition={{
                duration: 6,
                ...
                <motion.div className="absolute -bottom-4 -left-4 w-6 h-6 bg-blue-400 rounded-full opacity-40" animate={{
                scale: [1, 1.3, 1],
                y: [0, -10, 0]
              }} transition={{
                duration: 4,
        ...
        <motion.div className="max-w-6xl mx-auto mt-16 sm:mt-20 lg:mt-24" initial={{
        opacity: 0,
        y: 50
      }} animate={isInView ? {
        opacity: 1,
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <motion.div className="gradient-card rounded-2xl p-6" initial={{
                opacity: 0,
                x: -30
              }} animate={isInView ? {
                opacity: 1,
                ...
                duration: 0.4
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground text-sm">Customisable profiles showcasing achievements and progress</p>
                    </div>
                  </div>
                </motion.div>
